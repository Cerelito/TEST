...
/**
 * Renders a permission tree node recursively.
 */
function renderTreeNode(array $node, bool $editar = false): void {
    ...
    <div class="tree-item">
        ...
        <div class="tree-children" id="<?php echo $nodeId; ?>_children">
            <?php foreach ($node['children'] as $child): ?>
                <?php renderTreeNode($child, $editar); ?>
            <?php endforeach; ?>
        </div>
        <?php endif; ?>
    </div>
...
<div class="page-header">
    <div>
        <h2 class="page-header-title">Nuevo Programa Nivel</h2>
        <span style="font-size:13px; color:#64748b;">Define nombre, nivel y permisos de módulos</span>
    </div>
...
<form method="POST" action="<?php echo BASE_URL; ?>/programa-nivel/guardar" id="formPN">
    <?php echo csrfField(); ?>
    ...
    <div class="form-card">
        ...
        <div class="form-row form-row-2">
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Ej. Operativo Básico" required maxlength="100" value="<?php echo htmlspecialchars($_POST['nombre'] ?? ''); ?>">
            </div>
            <div class="form-group">
                <label class="form-label" for="nivel">Número de Nivel <span style="color:#f87171;">*</span></label>
                <input type="number" id="nivel" name="nivel" class="form-control" placeholder="1, 2, 3..." min="1" max="99" required value="<?php echo htmlspecialchars($_POST['nivel'] ?? ''); ?>">
            </div>
        </div>
        <div class="form-group" style="margin-bottom:0;">
            <label class="form-label" for="descripcion">Descripción</label>
            <textarea id="descripcion" name="descripcion" class="form-control" placeholder="Descripción breve de este nivel de programa..." rows="3"><?php echo htmlspecialchars($_POST['descripcion'] ?? ''); ?></textarea>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <p style="font-size:13px; color:#64748b; margin-bottom:16px;">Selecciona los módulos a los que tendrán acceso los empleados con este programa nivel. Los módulos padre seleccionarán automáticamente sus hijos.</p>
