...
<style>
    ...
    .role-vobo { background: rgba(52,211,153,0.15); color: #34d399; border: 1px solid rgba(52,211,153,0.3); }
    ...
    .icon-btn { display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; border-radius: 8px; border: 1px solid; cursor: pointer; transition: all 0.2s; text-decoration: none; background: none; }
...
<form method="GET" action="<?php echo BASE_URL; ?>/empleados" id="filterForm">
    <div class="filters-bar">
        ...
        <select name="empresa" class="form-control" style="min-width:160px;" onchange="this.form.submit()">
        ...
        <select name="tipo" class="form-control" style="min-width:160px;" onchange="this.form.submit()">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="badge badge-blue"><?php echo htmlspecialchars($emp['programa_nivel']); ?></span>
                        <?php else: ?>
