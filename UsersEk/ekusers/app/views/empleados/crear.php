...
<style>
    ...
    .cc-check-group { display:flex; gap:8px; }
    .cc-check-group label { display:flex; align-items:center; gap:4px; font-size:11px; color:#94a3b8; cursor:pointer; }
...
<div class="page-header">
    <div>
        <h2 class="page-header-title">Nuevo Empleado</h2>
        <span style="font-size:13px; color:#64748b;">Registra un nuevo empleado en el sistema</span>
    </div>
...
<form method="POST" action="<?php echo BASE_URL; ?>/empleados/guardar" id="formEmpleado">
    <?php echo csrfField(); ?>
        ...
        <div class="form-row form-row-3">
            ...
            <div class="form-group" style="margin-bottom:0;">
                ...
                <select id="programa_nivel_id" name="programa_nivel_id" class="form-control">
                    ...
                    <option value="<?php echo (int)$prog['id']; ?>"
                        <?php echo (($_POST['programa_nivel_id'] ?? '') == $prog['id']) ? 'selected' : ''; ?>>
            ...
            <div class="form-group" style="margin-bottom:0;">
                ...
                <div style="position:relative;">
                    ...
                    <input type="hidden" id="jefe_id" name="jefe_id" value="<?php echo htmlspecialchars($_POST['jefe_id'] ?? ''); ?>">
    ...
    <div class="form-card">
        ...
        <p class="section-hint">Por cada centro de costo especifica el tipo de documento (REQ/OC), el tipo de insumo y los permisos (Elaboración, Visto Bueno, Autorización).</p>

        <?php echo ccTablaHTML($empresas); ?>
