...
<div class="d-flex justify-between align-center mb-4">
    <div>
        <h1 class="section-title">
            <i class="bi bi-file-earmark-ruled"></i> Nuevo Régimen Fiscal
        </h1>
        <p class="section-subtitle">
            Agregar un nuevo régimen fiscal al catálogo
        </p>
    </div>
...
<form method="POST" action="<?= BASE_URL ?>catalogos/guardarRegimen" id="formRegimen">
    ...
    <div class="d-flex gap-2 justify-end mb-5">
        ...
        <button type="submit" class="btn btn-primary">
            <i class="bi bi-check-lg"></i> Guardar Régimen
        </button>
    </div>
</form>
