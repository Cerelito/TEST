<?php
// ─────────────────────────────────────────────
// Las credenciales NO deben estar en este archivo.
// Crea un archivo .env.permisos (fuera de public_html) con:
//   DB_HOST=localhost
//   DB_NAME=erickedu_ekpermisos
//   DB_USER=erickedu_cerelito
//   DB_PASS=TU_PASSWORD_AQUI
// ─────────────────────────────────────────────
$env_file = __DIR__ . '/../.env.permisos';
...
// Genera una clave en .env.permisos: API_KEY=una_clave_larga_aleatoria
// El cliente debe enviar el header: X-API-Key: <clave>
$api_key_esperada = $_ENV['API_KEY'] ?? '';
$api_key_recibida = $_SERVER['HTTP_X_API_KEY'] ?? '';

if (empty($api_key_esperada) || !hash_equals($api_key_esperada, $api_key_recibida)) {
