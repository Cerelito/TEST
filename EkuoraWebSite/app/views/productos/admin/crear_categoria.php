...
$titulo = 'Nueva Categoría | Ekuora Admin';
require_once VIEWS_PATH . 'layouts/header.php';
?>

<style>
    /* ============================================
       EKUORA ADMIN - NUEVA CATEGORÍA
...
<section class="ek-admin-hero ek-fade-up">
    <div class="ek-admin-hero-content">
        <div>
            <div class="ek-admin-hero-badge">Nueva Agrupación</div>
            <h1 class="ek-admin-hero-title">
                <i class="bi bi-plus-circle"></i>
                Nueva Categoría
            </h1>
            <p class="ek-admin-hero-subtitle">Añade un nuevo grupo para organizar tus productos.</p>
...
<form action="<?= BASE_URL ?>productos/guardar-categoria" method="POST" enctype="multipart/form-data">
        ...
        <div class="ek-main-column">
            ...
            <div class="ek-card ek-fade-up" style="animation-delay: 0.1s;">
                <div class="ek-card-header">
                    ...
                    <div>
                        <h3 class="ek-card-title">Información de la Categoría</h3>
                        <p class="ek-card-subtitle">Datos principales para la nueva categoría</p>
                    </div>
                </div>
                <div class="ek-card-body">
                    <div class="ek-form-group">
                        ...
                        <input type="text" name="nombre" class="ek-form-input"
                            placeholder="Ej: Hidratación, Cocina, Baño..." required autofocus>
                    </div>
                    ...
                    <div class="ek-form-row">
                        <div class="ek-form-group">
                            ...
                            <div class="ek-icon-input-group">
                                ...
                                <input type="text" name="icono" class="ek-form-input" id="icon-input"
                                    value="bi-box-seam" placeholder="bi-cup-straw">
                            </div>
                    ...
                    <div class="ek-info-tip">
                        ...
                        <p>
                            ...
                            Escribe el nombre completo incluyendo "bi-".
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="ek-card ek-fade-up" style="animation-delay: 0.2s; margin-top: 1.5rem;">
                ...
                <div class="ek-card-body">
                    <div class="ek-toggle-group">
                        <div class="ek-toggle-container active" id="toggle-activo">
                        ...
                        <div class="ek-toggle-container" id="toggle-destacado">
                            <div class="ek-toggle-label">
            ...
            <div class="ek-card ek-fade-up" style="animation-delay: 0.15s;">
                ...
                <div class="ek-card-body">
                    ...
                    <div class="ek-info-tip">
                        ...
                        <p>Recomendado: imagen de 800x450px (proporción 16:9) para mejor visualización en el catálogo.
                        </p>
                    </div>
                </div>
            </div>
