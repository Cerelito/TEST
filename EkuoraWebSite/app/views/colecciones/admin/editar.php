...
$titulo = 'Editar Colección | Ekuora Admin';
require_once VIEWS_PATH . 'layouts/header.php';
?>

<style>
    /* ============================================
       EKUORA ADMIN - EDITAR COLECCIÓN
...
<form action="<?= BASE_URL ?>colecciones/actualizar/<?= $coleccion['id'] ?>" method="POST"
        ...
        <div class="ek-main-column">
            ...
            <div class="ek-card ek-fade-up" style="animation-delay: 0.1s;">
                <div class="ek-card-header">
                    ...
                    <div>
                        <h3 class="ek-card-title">Detalles de la Colección</h3>
                        <p class="ek-card-subtitle">Información principal de la colección</p>
                    </div>
                </div>
                <div class="ek-card-body">
                    <div class="ek-form-group">
                        ...
                        <input type="text" name="nombre" class="ek-form-input" value="<?= e($coleccion['nombre']) ?>"
                            placeholder="Ej: Lo Más Vendido, Nuevos Lanzamientos..." required>
                    </div>

                    <div class="ek-form-group">
                        <label class="ek-form-label">Descripción</label>
                        <textarea name="descripcion" class="ek-form-textarea"
                            placeholder="Describe brevemente esta colección..."><?= e($coleccion['descripcion'] ?? '') ?></textarea>
                    </div>

                    <div class="ek-form-group">
                        <label class="ek-form-label">Orden de Aparición</label>
                        <input type="number" name="orden" class="ek-form-input" value="<?= $coleccion['orden'] ?>"
                            min="0" placeholder="0">
                ...
                <div class="ek-card-body">
                    <div class="ek-toggle-container">
                        ...
                        <label class="ek-toggle">
                            <input type="checkbox" name="activo" value="1" <?= $coleccion['activo'] ? 'checked' : '' ?>>
                    ...
                    <div class="ek-info-tip">
                        ...
                        <p>Las colecciones inactivas no aparecerán en el catálogo público pero se mantienen guardadas
                            para uso futuro.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="ek-side-column">
                ...
                <div class="ek-card-body">
                    ...
                    <div class="ek-current-image">
                        ...
                        <div class="ek-image-preview">
                            <?php if ($coleccion['imagen']): ?>
                                <img src="<?= e(asset($coleccion['imagen'])) ?>" alt="<?= e($coleccion['nombre']) ?>">
                            <?php else: ?>
                    ...
                    <div class="ek-info-tip">
                        ...
                        <p>Recomendado: imagen de 800x450px (16:9) para mejor visualización.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="ek-card ek-fade-up" style="animation-delay: 0.25s;">
                <div class="ek-card-body">
                    ...
                    <a href="<?= BASE_URL ?>colecciones/admin" class="ek-btn ek-btn-secondary" style="width: 100%;">
