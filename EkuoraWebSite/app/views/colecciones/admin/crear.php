...
$titulo = 'Nueva Colección | Ekuora Admin';
require_once VIEWS_PATH . 'layouts/header.php';
?>

<style>
    /* ============================================
       EKUORA ADMIN - NUEVA COLECCIÓN
    ...
    .ek-upload-preview.show {
        display: block;
    }

    .ek-upload-preview-box {
    ...
    .ek-upload-preview-box img {
        max-height: 180px;
        display: block;
    }

    .ek-upload-preview-label {
        margin-top: 0.75rem;
        font-size: 0.85rem;
        color: var(--ek-orange);
        font-weight: 600;
...
<section class="ek-admin-hero ek-fade-up">
    <div class="ek-admin-hero-content">
        <div>
            ...
            <p class="ek-admin-hero-subtitle">Crea un nuevo grupo de productos destacados para tu catálogo.</p>
            <nav class="ek-breadcrumb">
                <a href="<?= BASE_URL ?>dashboard"><i class="bi bi-house"></i></a>
                <span>/</span>
                <a href="<?= BASE_URL ?>colecciones/admin">Colecciones</a>
                <span>/</span>
                <span class="current">Nueva</span>
            </nav>
        </div>
        <a href="<?= BASE_URL ?>colecciones/admin" class="ek-btn ek-btn-outline">
            <i class="bi bi-arrow-left"></i> Volver al Listado
        </a>
    </div>
</section>

<form action="<?= BASE_URL ?>colecciones/guardar" method="POST" enctype="multipart/form-data">
        ...
        <div class="ek-main-column">
            ...
            <div class="ek-card ek-fade-up" style="animation-delay: 0.1s;">
                <div class="ek-card-header">
                    ...
                    <div>
                        <h3 class="ek-card-title">Información de la Colección</h3>
                        <p class="ek-card-subtitle">Configura el nombre y descripción</p>
                    </div>
                </div>
                <div class="ek-card-body">
                    <div class="ek-form-group">
                        <label class="ek-form-label">
                            Nombre de la Colección <span class="required">*</span>
                        </label>
                        <input type="text" name="nombre" class="ek-form-input"
                            placeholder="Ej: Especial de Verano, Lo Más Vendido..." required>
                    </div>
                    ...
                    <div class="ek-form-group">
                        ...
                        <input type="number" name="orden" class="ek-form-input" value="0" min="0" placeholder="0">
            ...
            <div class="ek-card ek-fade-up" style="animation-delay: 0.2s;">
                <div class="ek-card-header">
                    ...
                    <div>
                        <h3 class="ek-card-title">Estado de la Colección</h3>
                        <p class="ek-card-subtitle">Controla la visibilidad inicial</p>
                    </div>
                </div>
                <div class="ek-card-body">
                    <div class="ek-toggle-container">
                        <div class="ek-toggle-label">
                            <i class="bi bi-eye"></i>
                            <div>
                                <div class="ek-toggle-info">Colección Activa</div>
        ...
        <div class="ek-side-column">
            ...
            <div class="ek-card ek-fade-up" style="animation-delay: 0.15s;">
                ...
                <div class="ek-card-body">
                    ...
                    <!-- Image Preview -->
                    <div class="ek-upload-preview" id="upload-preview">
                        <div class="ek-upload-preview-box">
                            <img src="" alt="Preview" id="preview-img">
                        </div>
                        <div class="ek-upload-preview-label">
            ...
            <div class="ek-info-card ek-fade-up" style="animation-delay: 0.2s; margin-top: 1.5rem;">
                <div class="ek-info-card-header">
                    ...
                    <span>Ideas para Colecciones</span>
                </div>
                <p>Las colecciones son perfectas para destacar grupos especiales de productos:</p>
                <ul>
                    <li>Lo más vendido</li>
                    <li>Nuevos lanzamientos</li>
                    <li>Ofertas especiales</li>
                    <li>Temporada (Verano, Navidad...)</li>
                    <li>Por material o color</li>
                </ul>
            </div>
            ...
            <div class="ek-fade-up" style="animation-delay: 0.25s; margin-top: 1.5rem;">
                <button type="submit" class="ek-btn ek-btn-primary ek-btn-lg" style="width: 100%;">
                    <i class="bi bi-check-lg"></i> Crear Colección
                </button>
            </div>
        </div>
    </div>
