...
class Router
{
    ...
    private array $routes = [
        ...
        // Módulos ERP — CSV import
        'modulos-erp/descargar-plantilla' => ['ModulosErpController', 'descargarPlantilla'],
        'modulos-erp/importar-csv'        => ['ModulosErpController', 'importarCsv'],
        // Centros de Costo
